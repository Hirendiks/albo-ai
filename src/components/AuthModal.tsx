    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      ...
      <div className="relative w-full max-w-md my-auto rounded-3xl glass-panel-elevated p-6 sm:p-7 z-10 shadow-2xl border border-white/20 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="mt-5 pt-4 border-t border-white/10 text-center">
          <p className="text-[11px] text-slate-400 mb-2">Or test instantly with 1 tap:</p>
          <div className="flex flex-wrap items-center justify-center gap-2">
            <button
              type="button"
              disabled={isLoading}
              onClick={() => handleQuickSignIn("alex.dev@gmail.com", "Alex Chen")}
              className="px-2.5 py-1 rounded-lg text-xs glass-button text-cyan-300 hover:text-white"
            >
              alex.dev@gmail.com
            </button>
            <button
              type="button"
              disabled={isLoading}
              onClick={() => handleQuickSignIn("workspace.albo@gmail.com", "Albo User")}
              className="px-2.5 py-1 rounded-lg text-xs glass-button text-purple-300 hover:text-white"
            >
              workspace.albo@gmail.com
            </button>
          </div>
        </div>
      </div>
